...
|---|---|---|
| `replay_completion_predicate.py` | How often does the fleet's completion grep miss a real terminal outcome? | Open standards candidate [`S-fnpuwoy4`](../../../tracked/standards/S-fnpuwoy4.md); Memory Management Framework [Phase 1](../../../docs/development/memory-management-framework/phase1_measure_the_channel.md) E5 |
...
| `replay_convergence_events.py` | What the LIVE predicate actually said — including the `pass_not_evaluable` and `history_unreadable` rates the GitHub archive structurally cannot produce — and **Phase 5's gate conditions 1 and 2 with their denominators** | Candidate **C-wb1xc1xs**; [Phase 5](../../../docs/development/memory-management-framework/phase5_convergence_stopping.md) § What would let this gate; [Phase 6](../../../docs/development/memory-management-framework/phase6_read_what_it_writes.md) § Phase 5's un-owned activation |
