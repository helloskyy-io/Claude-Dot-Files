...
ACCEPTED: dict[str, str] = {
    ...
    "9b713b071043": "2x  1. **Read every existing row.** Note the highest `C-NNN` in use. 2",
    ...
    "9bdd8ca3fb0d": "2x  **Name the `component` this candidate belongs to when you file it*",
    "24772f55bccc": "2x  | Goes in `direction.md` | Goes in `candidates.md` | |---|---| | A",
    ...
    "76beb6715e0a": "2x  `${RESEARCH_DIR}/candidates.md` is the **durable** home for action",
    ...
    "7bac67d34fd3": "2x  **You are not the only writer.** `triage-candidates` also appends ",
    ...
    "e916c93f90e5": "2x  Some findings are not design work. They are **recommendations abou",
    "d092aa9c5e9c": "2x  Same discipline as `candidates.md`: **read every row first**, reus",
    "3621076d701f": "2x  **Use it. Do not repeat it.** A topic already covered upstream doe",
    "3bc9e96e36fa": "2x  **List the `direction.md` items separately from the candidates, as",
    "5e3a3b1c2da7": "2x  **BEFORE choosing any disposition below, ask: IS THIS ABOUT THE WO",
    "6f6d15a8c2f0": "2x  State plainly: how many candidates you **added**, how many you **r",
    ...
    "4d06820f0593": "2x  **You set:** `ID` · `Candidate` · `component` · `Source` **You NEV",
    ...
    "a39fe5427930": "2x  **You set:** `ID` · `Recommendation` · `Why it matters` · `Source`",
    "fcc2dfddf704": "2x  **You NEVER edit `problem-statement.md`.** It is the thesis every ",
    ...
    "31bd74ef54cf": "2x  Create it with the header explaining the two flags, who sets which",
