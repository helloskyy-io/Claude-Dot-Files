...
| **Add every phase doc you create to `docs/file_structure.txt`** — you hold this grant, and the merge gate needs it | |
...
- **Dependencies are NOT restated here** — `roadmap.md` is the single carrier; CITE its entry.
