...
**It rests on a change that was announced and deferred, not abandoned.** On 2026-05-14 Anthropic announced that Agent SDK **and `claude -p`** usage would leave subscription pools on 2026-06-15, moving to a monthly dollar credit at standard API rates with no rollover, **$200/month at Max 20×**. That change was **paused** on 2026-06-15, and **re-verified still paused on 2026-08-22**: headless `claude -p` runs and Agent SDK projects draw from the subscription exactly as before, the announced monthly credit was never made available, and Anthropic states it will give notice before anything takes effect. That notice commitment is itself part of the hedge, because it means the assumption below cannot fail silently. Third-party agents had been blocked outright on 2026-04-04 and reinstated in May under the same mechanism. Evidence: [`research/raw/anthropic_tos_and_enterprise.md`](research/raw/anthropic_tos_and_enterprise.md) §9.
