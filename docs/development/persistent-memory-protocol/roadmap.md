...
**It does not own:** the Temporal port ([`temporal-integration/`](../temporal-integration/temporal-integration.md)), or the fleet's deployment automation ([`C-2xgap6o1`](../../standards/architecture/research/candidates.md)).
