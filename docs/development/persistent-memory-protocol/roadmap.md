...
7. **Journal format at this volume, and redaction/classification for records crossing a trust boundary.** Both are genuine research questions and the strongest candidates for a full research cycle on this topic. Placed as [`C-077`](../../standards/architecture/research/candidates.md), which covers both the egress and the ingress halves of item 3.
