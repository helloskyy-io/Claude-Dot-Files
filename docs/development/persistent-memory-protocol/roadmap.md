...
**It does not own:** the Temporal port ([`temporal-integration/`](../temporal-integration/temporal-integration.md)), the fleet's deployment automation ([`C-2xgap6o1`](../../standards/architecture/research/candidates.md)), or **managed configuration and the digest of what a run absorbed** — that is [Workflow Decomposition Phase 5](../workflow-decomposition/phase5_configuration_a_run_absorbed.md)'s in full, by operator ruling on 2026-08-19.
...
**This protocol is its own component, not a phase of anything, by operator ruling on 2026-08-16** — the framework it would have been a phase of was retired into it. [`C-xh8nvwqn`](../../standards/architecture/research/candidates.md) asks the question; its `decision` is the triager's to set and this is the evidence.
...
- **[`C-2xgap6o1`](../../standards/architecture/research/candidates.md)** — deployment automation is a dependency of synthesis §13's redeploy path, sized as its own sprint, and explicitly not in this component.
...
3. **Journal format at this volume.** A genuine research question and the strongest remaining candidate for a full research cycle. Placed as [`C-l2doi8ox`](../../standards/architecture/research/candidates.md).
