...
- [ ] Mutual exclusion between two **simultaneous** openers of one bag — **unchecked, and its carrier does not exist yet**: the Temporal addendum has no identity section, tracked as [`C-120`](../../standards/architecture/research/candidates.md)
