...
- **Inside it:** none. This phase does not need [Phase 3](phase3_auditable_derivation.md), [Phase 4](phase4_producer_names_its_consumer.md) or [Phase 6](phase6_configuration_a_run_absorbed.md), and none of them needs it.
