...
- The 7 critical rules from Phase 5 apply to all work in this phase. They are non-negotiable. See `docs/development/sprint.md` Phase 5 "Critical Rules" section.
