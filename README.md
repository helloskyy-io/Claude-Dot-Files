...
- **9 autonomous workflows** — bash scripts that run Claude headless in isolated git worktrees, self-review work through agent panels, and deliver PRs ready for human review — including a research family (create + refresh) producing source-verified evidence pools
