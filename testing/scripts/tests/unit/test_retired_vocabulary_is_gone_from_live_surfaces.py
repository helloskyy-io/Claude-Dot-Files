...
RECORD_SURFACES: dict[str, str] = {
    ...
    "development/common/cpi-decisions.md":
        ...
        "exclusions",
    "development/derived/":
        "the planning viewer's derived artifacts — a reading of the whole "
        "corpus, regenerated by tool and never authored, gated by the viewer's "
        "own --check. A label a RECORD surface carries, its derivation carries "
        "too (the graph quotes the retired component's roadmap and the "
        "completed sprint entry); renaming it here is impossible, since the "
        "next generate would restore it, and renaming it at the source would "
        "falsify the record. Added 2026-09-18 when this repository adopted "
        "the viewer",
